...
The G6K-2F-Y Dual-Pole/Dual-Throw (DPDT) relay from Omron Electronic Components handles switching loads of 1A/30VDC and 0.3A/125VAC (at 40&deg;C) with very low drive currents.

The board isolates the high-power side of the relay with both a physical air-gap in the PCB along with an opto-isolator circuit.  
...
<figure markdown>
[![Board Dimensions](/docs/static/ref/SparkFun_Qwiic_Relay_1x1A_DPDT.jpg){ width="600"}](/docs/static/ref/SparkFun_Qwiic_Relay_1x1A_DPDT.jpg "Click to enlarge")
