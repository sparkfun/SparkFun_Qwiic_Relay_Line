...
const config: Config = {
    ...
    baseUrl: '/SparkFun_Qwiic_Relay_Line/',

    // GitHub pages deployment config.
    // If you aren't using GitHub pages, you don't need these.
    organizationName: 'sparkfun', // Usually your GitHub org/user name.
    projectName: 'SparkFun_Qwiic_Relay_Line', // Usually your repo name.
    ...
    themeConfig: {
        ...
        docsearch: {
            ...
            // to be used for the Qwiic Relay Line.  This is not available for AskAi.
            //
            ...
            // disabling AskAI for the Qwiic Relay Line - can revisit later.
            //
        ...
        navbar: {
            title: 'SparkFun Qwiic Relay Line Hookup Guide',
            logo: {
                alt: 'SparkFun Logo',
            ...
            items: [
                ...
                // },
                {
                    href: 'https://github.com/sparkfun/SparkFun_Qwiic_Relay_Line',
                    position: 'right',
